...
Array.prototype.randItem = function() { return this[Math.floor(Math.random() * Math.floor(this.length))] };
...
function findQuote() {
  ...
  if (noTwo(chosen.source) || noTwo(chosen.author)) document.getElementById('spaceBetweenInf').innerHTML = '';
